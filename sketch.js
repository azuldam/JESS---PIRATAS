...
function preload() {
  ...
  backgroundsonido = loadSound("assets/background_music.mp3")
  explosión = loadSound ("assets/cannon_explosion.mp3")
...
function draw() {
  ...
  if(!backgroundsonido.isPlaying()){
    ...
    backgroundsonido.setVolume(0.1) 
  }
